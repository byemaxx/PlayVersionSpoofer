...
public class SoterExportResult implements Parcelable {
    ...
    protected SoterExportResult(Parcel in) {
    ...
    public static final Creator<SoterExportResult> CREATOR = new Creator<SoterExportResult>() {
        @Override
        public SoterExportResult createFromParcel(Parcel in) { return new SoterExportResult(in); }

        @Override
        public SoterExportResult[] newArray(int size) { return new SoterExportResult[size]; }
    };
}
