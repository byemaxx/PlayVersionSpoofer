...
public class SoterDeviceResult implements Parcelable {
    ...
    public static final Creator<SoterDeviceResult> CREATOR = new Creator<SoterDeviceResult>() {
        @Override
        public SoterDeviceResult createFromParcel(Parcel in) { return new SoterDeviceResult(in); }

        @Override
        public SoterDeviceResult[] newArray(int size) { return new SoterDeviceResult[size]; }
    };
}
