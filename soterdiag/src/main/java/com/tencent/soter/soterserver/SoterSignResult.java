...
public class SoterSignResult implements Parcelable {
    ...
    public static final Creator<SoterSignResult> CREATOR = new Creator<SoterSignResult>() {
        @Override
        public SoterSignResult createFromParcel(Parcel in) { return new SoterSignResult(in); }

        @Override
        public SoterSignResult[] newArray(int size) { return new SoterSignResult[size]; }
    };
}
